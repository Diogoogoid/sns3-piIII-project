...
INSERT INTO PRODUTO (PROD_NOME, FABRICANTE, TIPOPROD, DESCRICAO, QUANTIDADE, STATUS, VALOR, GARANTIA, DATAFAB)
VALUES ('CORINTHIAS 100 ANOS','TIMÃO EDITORA','LIVRO', 'ASUDUISADUISA', 10,TRUE,10.99,3,'2011-09-15');

INSERT INTO PRODUTO (PROD_NOME, FABRICANTE, TIPOPROD, DESCRICAO, QUANTIDADE, STATUS, VALOR, GARANTIA, DATAFAB)
VALUES ('HOUSE OF CARDS - 1 TEMPORADA','CNS FILMES','FILME', 'SUHDUAISDIAS', 5,TRUE,49.98,3,'2000-09-15');

INSERT INTO PRODUTO (PROD_NOME, FABRICANTE, TIPOPROD, DESCRICAO, QUANTIDADE, STATUS, VALOR, GARANTIA, DATAFAB)
VALUES ('MONITOR LED 24 POLEGADAS','LG ','INFORMATICA', 'SAUHDAHS', 2,TRUE,599.99,12,'2017-08-25');

INSERT INTO CLIENTE (CLI_NOME, SEXO, STATUS, DATA, ESTADOCIVIL, CPF, TELEFONE, EMAIL, LOGRADOURO, NUMERO, CEP, BAIRRO, CIDADE, ESTADO)
VALUES ('JOSE ANTONIO','MASCULINO',TRUE,'1980-02-15','SOLTEIRO(A)','12521407895','1133219885','JOSE@GMAIL.COM','Rua Coronel Naul de Azevedo','850','04803070','Jardim Cruzeiro','SP','SÃ£o Paulo');

INSERT INTO CLIENTE (CLI_NOME, SEXO, STATUS, DATA, ESTADOCIVIL, CPF, TELEFONE, EMAIL, LOGRADOURO, NUMERO, CEP, BAIRRO, CIDADE, ESTADO)
VALUES ('ANTONIA MARCELIMO','FEMININO',TRUE,'1990-08-02','SOLTEIRO(A)','12507852189','1152256332','ANTMARC@GMAIL.COM','Rua Coronel Naul de Azevedo','850 APT 50','04803070','Jardim Cruzeiro','SP','SÃ£o Paulo');